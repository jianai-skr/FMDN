...
def select_model(args, device):
    ...
    if model_id == 0:
        ...
        name, data_range = f"{model_id:01}_FMDN_baseline", 1.0
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default="E:/datasets/DIV2K_LSDIR_valid/", type=str)
    parser.add_argument("--save_dir", default="E:/datasets/DIV2K_LSDIR_valid/results", type=str)
